...
class G_code_generator:
    ...
    def move_to_point(self, point, z, speed_factor=1, comment=None):
        ...
        x, y = point
        self.nozzle_locations.append(point)
        self.current_z = z
    ...
    def move_to_printing_point(self, point):
        ...
        """
        x, y, z = point
        self.nozzle_locations.append([x, y]) # adding point1 to object history
        self.current_z = z
    ...
    def _print_line(self, point0, point1, move_to_start=True, extrude_factor=1, speed_factor=1, comment=None):
        """
        Generates a g-code for a line without wipe/reptraction/unretraction. Movement to start point in optional.
    ...
    def print_line(self, point0, point1, z, extrude_factor=1, speed_factor=1, comment=None):
        """
    ...
    def print_connected_lines(self, lines, z, speed_factor=1, extrude_factor=1, comment=None):
        """
        ...
        for line in lines:
            ...
            self.nozzle_locations.append([x1, y1]) # adding point1 to object history
